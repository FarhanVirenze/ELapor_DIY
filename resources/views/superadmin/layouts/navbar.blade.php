            ...
            <div class="space-y-8">
                ...
                <div class="space-y-2">
                    ...
                    <a href="{{ route('superadmin.dashboard') }}"
                        ...
                        <i
                            class="fas fa-chart-bar text-[17px] w-5 {{ request()->routeIs('superadmin.dashboard') ? 'text-white' : 'text-gray-500 group-hover:text-red-700' }}"></i>
                        <span>Dashboard</span>
                    </a>

                    <a href="{{ route('superadmin.laporan.index') }}"
                        class="flex items-center gap-4 px-4 py-[10px] rounded-lg transition font-medium
    {{ request()->routeIs('superadmin.laporan.index')
        ? 'bg-gradient-to-b from-red-700 to-red-800 text-white'
        : 'hover:bg-red-100 hover:text-red-700 text-gray-800' }}">
                        <i
                            class="fas fa-file-alt text-[17px] w-5 {{ request()->routeIs('superadmin.laporan.index') ? 'text-white' : 'text-gray-500 group-hover:text-red-700' }}"></i>
                    ...
                    <a href="{{ route('superadmin.kelola-aduan.index') }}"
                        ...
                        {{ request()->routeIs('superadmin.kelola-aduan.*')
                            ? 'bg-gradient-to-b from-red-700 to-red-800 text-white'
                            : 'hover:bg-red-100 hover:text-red-700 text-gray-800' }}">
                        <div class="flex items-center gap-4">
                            <i
                                class="fas fa-comments text-[17px] w-5 {{ request()->routeIs('superadmin.kelola-aduan.*') ? 'text-white' : 'text-gray-500 group-hover:text-red-700' }}"></i>
                ...
                <!-- ADMIN -->
                <div class="space-y-2">
                    <p class="text-[12px] uppercase text-red-600 font-bold tracking-wide mb-2">Superadmin</p>

                    @php
                        $menus = [
                            [
                                'route' => 'superadmin.kelola-user.*',
                                'icon' => 'fa-users-cog',
                                'label' => 'Kelola User',
                                'url' => route('superadmin.kelola-user.index'),
                            ],
                            [
                                'route' => 'superadmin.kelola-kategori.*',
                                'icon' => 'fa-tags',
                                'label' => 'Kelola Kategori',
                                'url' => route('superadmin.kelola-kategori.index'),
                            ],
                            [
                                'route' => 'superadmin.kelola-wilayah.*',
                                'icon' => 'fa-map-marker-alt',
                                'label' => 'Kelola Wilayah',
                                'url' => route('superadmin.kelola-wilayah.index'),
                            ],
                            [
                                'route' => 'superadmin.kategori-admin.*',
                                'icon' => 'fa-user-shield',
                                'label' => 'Kategori Admin',
                                'url' => route('superadmin.kategori-admin.index'),
                            ],
                            [
                                'route' => 'superadmin.peta.*',
                                'icon' => 'fa-map',
                                'label' => 'Peta Aduan',
                                'url' => route('superadmin.peta.index'),
                            ],
                            [
                                'route' => 'superadmin.activity-logs.index',
                                'icon' => 'fa-history',
                                'label' => 'Log Aktivitas',
                                'url' => route('superadmin.activity-logs.index'),
                            ],
                        ];
                    @endphp
            ...
            <div class="flex items-center gap-4 w-full">
                ...
                <div class="flex items-center ml-auto gap-3">
                    @auth
                        ...
                        <!-- Profile placeholder to fix syntax -->
                                ...
                                <a href="{{ route('superadmin.profile.edit') }}"
                                    ...
                                    <i
                                        class="fas fa-user text-[16px] w-5 
                                                                                                                                                {{ request()->routeIs('superadmin.profile.edit') ? 'text-white' : 'text-gray-500 group-hover:text-red-700' }}"></i>
                                    <span>Profil</span>
                                </a>
                            </x-slot>
                        </x-dropdown>
                ...
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <a href="{{ route('superadmin.profile.edit') }}"
                            ...
                            <i
                                class="fas fa-user text-[16px] w-5
                                                                            {{ request()->routeIs('superadmin.profile.edit') ? 'text-white' : 'text-gray-500 group-hover:text-red-600' }}"></i>
                            <span>Profil</span>
                        </a>
                    </x-slot>
                </x-dropdown>
