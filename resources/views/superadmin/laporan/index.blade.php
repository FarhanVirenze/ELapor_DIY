    ...
    <div class="container mt-4">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            ...
            <div class="flex gap-3 mb-4">
                <a href="{{ route('superadmin.laporan.export.excel', [
                ...
                <a href="{{ route('superadmin.laporan.export.pdf', [
                    'admin_id' => request('admin_id'),
                    'kategori_id' => request('kategori_id'),
                    'wilayah_id' => request('wilayah_id'),
                    'status' => request('status'),
        ...
        <div class="mb-6 bg-white p-4 md:p-5 rounded-2xl shadow-lg border border-gray-200 animate-fade-in">
            <form method="GET" action="{{ route('superadmin.laporan.index') }}"
                ...
                <span class="text-base md:text-lg font-bold text-gray-800 w-full md:w-auto">
                    Filter Data:
                </span>
        ...
        <div class="bg-white shadow-xl rounded-2xl p-4 md:p-6 space-y-6">
            ...
            <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                ...
                <div class="w-full md:w-1/3">
                    <form method="GET" action="{{ route('superadmin.laporan.index') }}" class="relative">
                    ...
                    <table class="min-w-full table-auto text-sm text-gray-800">
                        <thead class="bg-red-700 text-white text-xs uppercase tracking-wider">
                            <tr>
                                ...
                                <th class="p-3 text-left font-bold hidden xl:table-cell">Admin/OPD</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-100">
                            ...
                            @foreach ($reports as $report)
                                ...
                                <tr class="hover:bg-red-50 transition-all duration-200">
                                    ...
                                    <td class="p-3 align-top hidden xl:table-cell text-xs">{{ $report->admin?->name ?? '-' }}</td>
                                ...
                                <tr id="detail-row-{{ $loop->iteration }}" class="detail-row hidden">
                                    <td colspan="11" class="bg-gray-50 border-t border-b py-2 px-5">
                                        ...
                                        <div class="tab-content" id="detail-{{ $loop->iteration }}">
                                            <div class="space-y-2 text-sm">
                                                ...
                                                <div class="grid grid-cols-1 gap-1">
                                                    ...
                                                    {{-- Admin/OPD --}}
                                                    <p class="flex">
                                                        <span class="font-semibold w-36 flex-shrink-0">Admin / OPD</span>
                                                        <span class="flex-grow">:
                                                            {{ $report->admin?->name ?? '-' }}</span>
                                                    </p>
