...
class ReportAdminController extends Controller
{
    ...
    public function show($id)
    {
        ...
        // Status stays 'Diajukan' until manual action is taken
    ...
    public function update(Request $request, $id)
    {
        ...
        if (!empty($changes)) {
            $this->logActivity(
                ...
                'Report',
                $report->id,
                "Admin memperbarui laporan #{$report->tracking_id}",
                $changes
            );
        }
        ...
        if ($oldStatus !== $newStatus) {
            ...
            // Opsional: Notifikasi ke Superadmin jika perlu (sesuai request "admin dan superadmin juga")
    ...
    public function deleteFile($id, $index)
    {
        ...
        if (isset($files[$index])) {
            ...
            $this->logActivity(
                ...
                'Report',
                $report->id,
                "Admin menghapus lampiran pada laporan #{$report->tracking_id}",
    ...
    public function storeFollowUp(Request $request, $reportId)
    {
        ...
        $this->logActivity(
            ...
            'FollowUp',
            $followUp->id,
            "Admin menambahkan tindak lanjut pada laporan #{$report->tracking_id}",
            ['pesan' => $request->pesan]
        );
    ...
    public function storeComment(Request $request, $reportId)
    {
        ...
        if (Auth::user()->role === 'admin') {
            ...
            $this->logActivity(
                ...
                'Comment',
                $comment->id,
                "Admin menambahkan komentar pada laporan #{$report->tracking_id}",
                ['pesan' => $request->pesan]
            );
        }
    ...
    public function deleteComment($id)
    {
        ...
        if ($user->role === 'superadmin') {
            if ($comment->user_id !== $user->id_user) {
        ...
        $this->logActivity(
            ...
            'Comment',
            $id,
            "Admin menghapus komentar pada laporan #{$comment->report->tracking_id}"
        );
    ...
    public function deleteFollowUp($reportId, $followUpId)
    {
        ...
        $this->logActivity(
            ...
            'FollowUp',
            $followUpId,
            "Admin menghapus tindak lanjut pada laporan #{$followUp->report->tracking_id}"
        );
    ...
    {
        if ($comment->user_id !== Auth::user()->id_user && Auth::user()->role !== 'admin') {
        ...
        $this->logActivity(
            ...
            'Comment',
            $comment->id,
            "Admin memperbarui komentar pada laporan #{$comment->report->tracking_id}",
            ['pesan' => $request->pesan]
        );
    ...
    public function updateFollowUp(Request $request, $id)
    {
        ...
        if (Auth::user()->role !== 'admin' && $followUp->user_id !== Auth::user()->id_user) {
        ...
        $this->logActivity(
            ...
            'FollowUp',
            $followUp->id,
            "Admin memperbarui tindak lanjut pada laporan #{$followUp->report->tracking_id}",
            ['pesan' => $request->pesan]
        );
